...
player addPrimaryWeaponItem (phx_loadout_automaticrifle_mag select [0, count phx_loadout_automaticrifle_mag - 2]);
[phx_loadout_automaticrifle_mag, "vest"] call phx_fnc_loadout_handleGear;
